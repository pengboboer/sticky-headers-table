...
class StickyHeadersTableInNested extends StatefulWidget {
  StickyHeadersTableInNested({
    Key? key,
  ...
  @override
  _StickyHeadersTableInNestedState createState() => _StickyHeadersTableInNestedState();
}

class _StickyHeadersTableInNestedState extends State<StickyHeadersTableInNested> {
  ...
  Widget build(BuildContext context) {
    ...
    /// Customize multiple Scroller linkage methods, usually used when the header is in NestedScrollView
    widget.scrollControllers.customNotificationListener = _onHorizontalScrollingNotification;
